...
// Update prompt as required for the current assignment:
...
// Additional error string macro definitions added at the bottom
#define RC_PRINT_FMT "%d\n"
#define ERR_CD_DIR "cd: error: cannot change directory to %s\n"
#define ERR_CD_ARGS "cd: too many arguments\n"
#define ERR_EXECVP "execvp: error: %s\n"
#define ERR_CMD_PARSE "Error: Command parsing failed with code %d\n"

#define PERROR(msg) do { fprintf(stderr, "Error: %s: %s\n", msg, strerror(errno)); } while(0)
